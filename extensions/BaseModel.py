...
class BaseModel(Model):
    ...
    sort_timestamp = models.BigIntegerField(validators=[MinValueValidator(limit_value=0)], verbose_name='排序时间戳，默认等于创建时间戳')
    create_timestamp = models.BigIntegerField(validators=[MinValueValidator(limit_value=0)], verbose_name='创建时间戳')
    update_timestamp = models.BigIntegerField(validators=[MinValueValidator(limit_value=0)], verbose_name='更新时间戳')
